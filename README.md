...
A cycle-accurate C++ instruction-set simulator with an SDL2-based graphical "digital twin," paired with a from-scratch Verilog CPU core that runs the exact same compiled firmware on real FPGA silicon.
